...
public class GuiModelBody extends noppes.mpm.client.gui.util.GuiModelInterface {
    ...
    public void initGui() {
        ...
        y += 22;
        addButton(new GuiNpcButton(1, this.guiLeft + 50, y, 70, 20, this.arrBreasts, this.playerdata.breasts));
        addLabel(new GuiNpcLabel(1, "Breasts", this.guiLeft, y + 5, 16777215));

        ModelPartData wing = this.playerdata.getPartData("wings");
        y += 22;
        addButton(new GuiNpcButton(0, this.guiLeft + 50, y, 70, 20, this.arrWing, wing == null ? 0 : wing.type + 1));
        ...
        y += 22;
        addButton(new GuiNpcButton(4, this.guiLeft + 50, y, 70, 20, this.arrskirt, getFinIndex(skirt)));
