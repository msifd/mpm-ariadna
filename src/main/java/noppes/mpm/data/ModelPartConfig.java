...
public class ModelPartConfig {
    ...
    public void readFromNBT(NBTTagCompound compound) {
        this.scaleX = checkValue(compound.getFloat("ScaleX"), 0.25F, 2.0F);
        this.scaleY = checkValue(compound.getFloat("ScaleY"), 0.25F, 2.0F);
        this.scaleZ = checkValue(compound.getFloat("ScaleZ"), 0.25F, 2.0F);
